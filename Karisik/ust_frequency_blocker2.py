...
class USTFrequencyBlocker:
    ...
    def generate_pink_noise(self, duration_sec=1.0):
        ...
        # Uyarı önleme: freqs array'ini kopyala ve DC'yi 1 yap
        freqs_safe = freqs.copy()
        freqs_safe[0] = 1.0  # DC bileşeni için güvenli değer
        
        pink_spectrum = 1 / np.sqrt(freqs_safe)
    ...
    def status_monitor_thread(self):
        ...
        while self.running:
            ...
            if total > 0:
                ...
                print("Kanal A bloke: 0 (veri bekleniyor...)")
                print("Kanal C yönlendirme: 0 (veri bekleniyor...)")
                print("Kanal Q arbitrasyon: 0")
                print()
                print("UST Etkinlik: Veri toplanıyor...")
            print(f"{'='*70}")
